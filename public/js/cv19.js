...
fetch("/stats").then((response)=>{
  response.json().then((data)=>{
    ...
    document.getElementById("count6").textContent=addCommas(data.date_by_date[data.date_by_date.length-1].confirmed-data.date_by_date[data.date_by_date.length-2].confirmed)
    document.getElementById("count7").textContent=addCommas(data.date_by_date[data.date_by_date.length-1].recovered-data.date_by_date[data.date_by_date.length-2].recovered)
    document.getElementById("count8").textContent=addCommas(data.date_by_date[data.date_by_date.length-1].deceased-data.date_by_date[data.date_by_date.length-2].deceased)
